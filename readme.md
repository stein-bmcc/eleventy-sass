...
> This is a minimal eleventy starter designed to have a similar structure to a basic web site. Thanks to Stephanie Eckles's 
...
3. Open the repository folder if you didn't already in the previous step. Remember to always open the folder and not individual files!
...
7. Edit `index.md` to change the home page, and then create content within `src/pages` using any templating format you prefer to add content.
